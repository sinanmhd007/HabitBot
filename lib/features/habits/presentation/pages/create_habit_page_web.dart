...
class CreateHabitPageWeb extends StatefulWidget {
  final HabitEntity? habitToEdit;

  const CreateHabitPageWeb({super.key, this.habitToEdit});

  @override
  State<CreateHabitPageWeb> createState() => _CreateHabitPageWebState();
}

class _CreateHabitPageWebState extends State<CreateHabitPageWeb> {
